...
public class InsertTestData {
    ...
    VALUES 
    (1, 'p1','Κτίριο Β-101',3,3),  --  Τώρα έχει 3/3 (Full)
    (2,'p2','Κτίριο Β-102',3,3),   --  Τώρα έχει 3/3 (Full)
    (3,'p3','Κτίριο Α-201',3,2),   --  Τώρα έχει 2/3
    (4,'p4','Κτίριο Α-205',3,0),
    (5,'p5','Κτίριο Β-305',3,1),   -- Τώρα έχει 1/3
...
""");
            ...
            // ── COURSES (100% ΕΥΘΥΓΡΑΜΜΙΣΜΕΝΟ ΜΕ ΤΟ PDF ΚΑΙ ΤΙΣ ΛΙΣΤΕΣ ΣΑΣ) ──────────────────────────────
            conn.createStatement().execute("""
    ...
    -- === ΜΑΘΗΜΑΤΑ ΥΠΟΧΡΕΩΤΙΚΑ ΚΑΤ' ΕΠΙΛΟΓΗΝ ΚΑΤΕΥΘΥΝΣΕΩΝ ===
    ...
    ('CEID_NE520','Αλγόριθμοι και Εφαρμογές Τεχνητής Νοημοσύνης για το Διαδίκτυο των Αντικειμένων (ΙοΤ)','Τομέας ΕΘ',5,8,0,1,'K1:B,K2:A,K3:B,K4:B,K5:B,K6:B',1,7.9,7.5),
    ...
    ('CEID_NE4017','Μαθηματική Λογική και Εφαρμογές της','Τομέας ΕΘ',5,8,0,1,'K1:B',1,7.1,7.0),
    ...
    ('CEID_24EE596','Μέθοδοι Μητρώων και Υπολογιστικά Εργαλεία στην Επιστήμη Δεδομένων','Τομέας ΛΥ',5,8,0,1,'K1:B,K3:B,K6:B',1,7.3,7.5),
    
    -- Κ2 Επιπλέον Μοναδικά Μαθήματα
    ('CEID_NE592','Βασικές Αρχές Δικτύων Κινητών Επικοινωνιών','Τομέας YA',5,7,1,0,'K2:A',1,7.5,7.0),
    ('CEID_NE489','Ευφυείς Τεχνολογίες Ασύρματων και Κινητών Επικοινωνιών','Τομέας YA',5,7,1,0,'K2:A,K4:B',1,7.3,7.0),
    ('CEID_NE577','Αρχιτεκτονικές δικτύων επόμενης γενιάς, Τεχνολογίες και Εφαρμογές','Τομέας YA',5,8,1,0,'K2:A',1,7.4,7.2),
    ...
    ('CEID_25EX600','Προχωρημένα Θέματα Ψηφιακών Τηλεπικοινωνιών','Τομέας YA',5,7,0,1,'K2:B',1,7.0,6.9),
    ('CEID_NE4157','Δίκτυα Δημόσιας Χρήσης και Διασύνδεση Δικτύων','Τομέας ΕΘ',5,7,0,1,'K2:B',1,7.4,7.0),
    ('CEID_NE5178','Τηλεματική και Νέες Υπηρεσίες','Τομέας ΕΘ',5,8,0,1,'K2:B',1,7.2,6.8),
    ('CEID_NE4547','Τεχνικές εκτίμησης υπολογιστικών συστημάτων και δικτύων','Τομέας ΛΥ',5,7,0,1,'K2:B,K5:B,K6:B',1,7.0,6.8),
    ('CEID_NE576','Διάχυτος Υπολογισμός','Τομέας ΛΥ',5,8,0,1,'K2:B,K5:A,K6:B',1,7.4,7.0),
    
    -- Κ3 Επιπλέον Μοναδικά Μαθήματα
    ...
    ('CEID_NE4847','Στατιστική Επεξεργασία Σήματος και Θέματα Μηχανικής Μάθησης','Τομέας YA',5,7,1,0,'K3:A',1,7.6,7.3),
    ...
    ('CEID_NE5657','Επεξεργασία και κατανόηση φυσικής γλώσσας','Τομέας ΛΥ',5,7,0,1,'K3:B',1,7.6,7.4),
    ('CEID_N2M05','Διαδραστικές Τεχνολογίες','Τμήμα Ηλεκτρολόγων',5,7,0,1,'K3:B',1,8.3,7.2),
    ('CEID_NE579','Εφαρμογές της Ψηφιακής Επεξεργασίας Σημάτων','Τομέας YA',5,8,0,1,'K3:B,K4:B',1,7.4,7.2),
    ('CEID_NE588','Ενσωματωμένα Συστήματα','Τομέας YA',5,8,0,1,'K3:B,K4:A',1,7.6,7.2),
    ('CEID_NE593','Επεξεργασία Σημάτων, θεωρία Γραφημάτων και Μάθηση','Τομέας YA',5,8,0,1,'K3:B',1,7.5,7.3),
    ('CEID_25EX603','Προγραμματισμός Συστημάτων Μηχανικής Μάθησης','Τομέας ΛΥ',5,7,0,1,'K3:B,K4:B',1,7.2,7.0),
    
    -- Κ4 Επιπλέον Μοναδικά Μαθήματα
    ('CEID_NE5678','Σχεδιασμός Συστημάτων Ειδικού Σκοπού','Τομέας YA',5,7,1,0,'K4:A',1,7.0,7.0),
    ('CEID_NE4648','Εισαγωγή σε VLSI','Τομέας YA',5,7,1,0,'K4:A',1,7.2,7.5),
    ('CEID_NE4617','Προχωρημένα Θέματα Αρχιτεκτονικής Υπολογιστών','Τομέας YA',5,8,1,0,'K4:A',1,7.4,7.5),
    ('CEID_NE4658','Σχεδίαση Συστημάτων με Χρήση Υπολογιστών (CAD)','Τομέας YA',5,8,1,0,'K4:A',1,7.1,7.2),
    ...
    ('CEID_NE5668','Ειδικά Θέματα Σχεδίασης Ψηφιακών Συστημάτων','Τομέας YA',5,8,0,1,'K4:B',1,7.3,7.0),
    
    -- Κ5 Επιπλέον Μοναδικά Μαθήματα
    ('CEID_NE5407','Λογισμικό & Προγραμματισμός Συστημάτων Υψηλής Επίδοσης','Τομέας ΛΥ',5,7,1,0,'K5:A,K6:A',1,7.8,8.0),
    ('CEID_24EE595','Διαχείριση έργων λογισμικού και ανάπτυξη με ευέλικτες μεθόδους','Τομέας ΛΥ',5,8,1,0,'K5:A',1,8.3,6.0),
    ('CEID_NE5577','Ποιότητα Λογισμικού','Τομέας ΛΥ',5,7,1,0,'K5:A',1,7.5,6.5),
    ('CEID_NE584','e-Επιχειρείν','Τομέας ΛΥ',5,7,0,1,'K5:B',1,7.5,5.8),
    ('CEID_NE5908','Κοινωνικές και Νομικές Πλευρές της Τεχνολογίας','Τομέας ΛΥ',5,8,0,1,'K5:B',1,7.2,5.5),
    ('CEID_NE444','Αναπαράσταση Γνώσης στον Παγκόσμιο Ιστό','Τομέας ΛΥ',5,7,0,1,'K5:B',1,7.4,7.1),
    ('CEID_NE1411','Τεχνολογίες και αλγόριθμοι αποκεντρωμένων δεδομένων','Τομέας ΛΥ',5,7,0,1,'K5:B,K6:B',1,7.8,7.5),
    
    -- Κ6 Επιπλέον Μοναδικά Μαθήματα
    ('CEID_NE4348','Συστήματα Διαχείρισης Μεγάλων Δεδομένων','Τομέας ΛΥ',5,8,1,0,'K6:A,K5:B,K3:B',1,8.2,7.8),
    ...
    -- === ΠΙΝΑΚΑΣ 2 & 4: ΜΑΘΗΜΑΤΑ ΓΕΝΙΚΗΣ ΠΑΙΔΕΙΑΣ (ΓΠ) - ΑΛΛΑ ΤΜΗΜΑΤΑ ===
...
""");
            ...
            conn.createStatement().execute("""
                ...
                (9,11,'Βαθιά Μάৃত্বρη για Αναγνώριση Εικόνας',
            ...
            // ── PROFESSOR-COURSE (100% ΕΥΘΥΓΡΑΜΜΙΣΜΕΝΟ ΜΕ ΤΟΥΣ ΚΩΔΙΚΟΥΣ ΤΟΥ PDF) ─────────────────
            conn.createStatement().execute("""
